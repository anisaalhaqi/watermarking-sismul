...
<div align="center">
  <p><b>Hasil Ekstraksi Exp 1 (Gagal)</b></p>
  <img src="experiment_evidence/exp1_extracted_failed.png" width="300">
  <br><i>Watermark berubah menjadi noise visual</i>
</div>
...
<div align="center">
  <p><b>Hasil Embedding Exp 2</b></p>
  <img src="experiment_evidence/exp2_embedded_grayscale.png" width="400">
  <br><i>Warna hilang total</i>
</div>
...
<div align="center">
  <table>
    <tr>
      <td align="center"><b>Citra Host (Original)</b></td>
      <td align="center"><b>Citra Ter-embed (Watermarked)</b></td>
    </tr>
    <tr>
      <td><img src="data/foto_wajah.jpg" width="350"></td>
      <td><img src="results/watermarked/watermarked_BASE.png" width="350"></td>
    </tr>
    <tr>
      <td align="center"><b>PSNR: ∞</b> (Baseline)</td>
      <td align="center"><b>PSNR: 53.60 dB</b></td>
    </tr>
  </table>
  <p><b>Analisis Visual:</b> Kedua gambar di atas secara visual identik. Tidak ada artefak atau noise yang terlihat mata manusia (PSNR > 50 dB).</p>
</div>

---

### 3.2 Input Watermark (Data Tersembunyi)
Data logo biner yang disisipkan secara tersebar ke dalam kanal hijau pada Bit-3.

<div align="center">
  <img src="data/input.png" width="150">
  <br><i>Watermark (Biner)</i>
</div>
...
<div align="center">
  <p><b>Hasil Ekstraksi per QF</b></p>
  <img src="results/exp1_watermark_extraction.png" width="800">
</div>
...
<div align="center">
  <table>
    <tr>
      <td align="center"><b>Grafik Analisis (BER vs PSNR)</b></td>
      <td align="center"><b>Tabel Metrik Lengkap</b></td>
    </tr>
    <tr>
      <td><img src="results/exp1_ber_psnr_chart.png" width="450"></td>
      <td><img src="results/exp1_table.png" width="450"></td>
    </tr>
  </table>
</div>
...
## 04 — Lampiran
- **Repository**: [github.com/anisaalhaqi/watermarking-sismul](https://github.com/anisaalhaqi/watermarking-sismul)
- **Instalasi**:
  ```bash
